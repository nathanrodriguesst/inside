...
std::unique_ptr<sql::Connection> DBConnector::generateDatabaseConnectionInstance(const std::string& host, const std::string& user, const std::string& password, const std::string& database) {
    try {
